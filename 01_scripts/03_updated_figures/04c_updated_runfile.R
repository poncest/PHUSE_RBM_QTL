...
## Run File to generate the selected figures  02_img/03_updated_figures

# Read data
source(here::here("01_scripts/03_updated_figures/01c_updated_read_data.R"))

# Data wrangling 
source(here::here("01_scripts/03_updated_figures/02c_updated_data_wrangling.R"))

# Generate output (table or visual)
source(here::here("01_scripts/03_updated_figures/03c_updated_data_visualization.R")) 
